...
dic_completo = {0: '', 1: 'I', 2: 'II', 3: 'III', 4: 'IV', 5: 'V', 6: 'VI', 7: 'VII', 8: 'IIX', 9: 'IX',
                10: 'X', 20: 'XX', 30: 'XXX', 40: 'XL', 50: 'L', 60: 'LX', 70: 'LXX', 80: 'XXC', 90: 'XC',
...
def entero_a_romano(numero):
    ...
    valor_num = 1000  #Para el while

    while cont < 4:     #solucionar que no funciona para menos de 1000
        list_numero[cont] = int(list_numero[cont])*valor_num
        valor_romano += dic_completo.get(list_numero[cont])
        cont += 1
